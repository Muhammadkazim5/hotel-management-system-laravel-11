                ...
                <div class="book_room">
                   ...
                   <form class="book_now">
                      <div class="row">
                         <div class="col-md-12">
                            <span>Arrival</span>
                            <img class="date_cua" src="{{asset('assets/images/date.png')}}" style="position: relative;top:37px;left:303px">
                            <input class="online_book" placeholder="dd/mm/yyyy" type="date" name="dd/mm/yyyy">
                         </div>
                         <div class="col-md-12">
                            <span>Departure</span>
                            <img class="date_cua" src="{{asset('assets/images/date.png')}}" style="    position: relative;
                            top: 37px;
                            left: 303px;">
                            <input class="online_book" placeholder="dd/mm/yyyy" type="date" name="dd/mm/yyyy">
                         </div>
